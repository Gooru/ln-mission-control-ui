  ...
  <div id="profile-info">
    <div class="profile-info-description">
      ...
      <div class="profile-button">
        ...
        <button
          class="btn-links"
          v-if="partnerProfile.images && partnerProfile.images.length"
          v-b-modal="'my-modal'"
          @click="galleryImage('image')"
        >{{$tc('image',2)}}</button>
          <button class="btn-videos"
          v-if="partnerProfile.videos && partnerProfile.videos.length"
          v-b-modal="'my-modal'"
...
<script lang="ts" src="./profile-info.ts"></script>
<style lang="scss" scoped src="./profile-info.scss"></style>
