...
export default class LineChart extends Vue {
    ...
    private drawLineChart(data: any) {
        ...
        const xMaxValue: any = xMinValue + (data.length + 0.3 - 1);
        ...
        svg.append('g')
            ...
            .call(d3.axisBottom(x).ticks(data.length).tickSize(10).tickFormat((d: any) => {
    ...
    private tooltipActive(d: any, x: any, y: any) {
        ...
        this.tooltipData = d.completedCompetencies;
    }
