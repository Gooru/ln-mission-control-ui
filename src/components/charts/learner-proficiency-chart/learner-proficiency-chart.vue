    ...
    <div class="chart-view">
      <div v-if="taxonomyGrades.length > 0" class="grade-selector">
        <div class="grade-label">
          ...
          <span class="grade-header"  @click="isToggleGrade = !isToggleGrade">Level Selector</span>
          <span v-for="(items, index) in selectedGradeList" :key="index" class="selected-grade">{{items.grade}}</span>
        </div>
        <div class="taxonomy-grade-list" v-if="isToggleGrade">
          <div class="backdrops" @click="isToggleGrade = !isToggleGrade"></div>
