    ...
    <div class="summary-content">
        <div class="summary-resource-question">
            ...
            <div class="summary-chart-footer">
                 <div v-for="(item, index) in summaryCatalogFooter" :key="index" class="footer-icon"><mc-icon :icon="item.type+'-gray'"/>  {{Object.keys(learnerContent).length ? learnerContent.totalHitCount[item.type] : ''}}</div>
            </div>
        </div>
    </div>
</template>

<script lang="ts" src="./summary-content.ts"></script>
<style lang="scss" src="./summary-content.scss"></style>